...
# VPS Cleanup Script for neversatisfiedxo Premium Trailer Gallery v2.6.0
...
echo "🧹 Cleaning VPS for neversatisfiedxo Premium Trailer Gallery v2.6.0"
echo "📅 Date: $(date)"
...
echo ""
print_success "🚀 VPS is now clean and ready for fresh v2.6.0 deployment!"
print_status "Run ./scripts/deploy-production-v2.6.0.sh to deploy the new version"
echo ""
