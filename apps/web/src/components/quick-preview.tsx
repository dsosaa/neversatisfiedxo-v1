...
// import { CloudflarePlayer } from '@/components/cloudflare-player' // Not used anymore
...
export function QuickPreview({ trailer, open, onOpenChange }: QuickPreviewProps) {
  ...
  useEffect(() => {
    if (open && trailer) {
      // Quick preview opening for video
      // Immediate ready state for mobile compatibility
                ...
                <div className="space-y-4">
                  ...
                  {trailer.description && (
                    <div className="space-y-3">
                      <div className="bg-zinc-900/50 border border-zinc-800/60 rounded-lg p-4 backdrop-blur-sm">
                        <p className="text-sm text-zinc-200 leading-relaxed font-medium tracking-wide">
                          {trailer.description}
                        </p>
                      </div>
                    </div>
