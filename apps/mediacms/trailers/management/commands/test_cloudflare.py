...
from trailers.services import CloudflareStreamService, get_cloudflare_service
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--video-uid", type=str, help="Test with a specific video UID"
        )
        parser.add_argument(
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            f'  Customer Code: {"✓ Set" if customer_code else "⚠ Optional"}'
        )
